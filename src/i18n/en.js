export default {
  ...
  timeline: {
    ...
    items: [
      ...
      { year: '2018', place: 'PLC.01', role: 'Fullstack · React', domain: 'Fintech',
        detail: 'Jira reporting tool via REST API. Slack bot for process automation. Multilingual financial blog (WordPress plugins). PWA financial portal with React/Redux/WebSocket.',
      ...
      { year: '2020', place: 'FutureComes', role: 'Next + Nest', domain: 'GameDev CRM · PropTech · Crypto',
        detail: 'Three projects: estoty.com game studio CRM (Next.js + NestJS). themetters.ru property aggregator — Python scrapers parsing listings from multiple platforms, feeding data into ML models for aggregation and display. Bequant crypto blog with Vue.js CMS.',
      ...
      { year: '2022.01', place: 'Lanck Telecom', role: 'Fullstack Developer', domain: 'Telecom · Antifraud',
        detail: 'UI component library (Ant Design → npm package via Swagger). Antifraud data admin panels. Strapi CMS for landing pages. LDAP/Active Directory integration for SSO and RBAC. Team of 2 devs.',
