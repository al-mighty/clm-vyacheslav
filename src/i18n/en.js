export default {
  ...
  timeline: {
    ...
    items: [
      ...
      { year: '2025.02', place: 'b-charge', role: 'Senior · Fullstack / DevOps', domain: 'HR-tech → Outstaffed to Sber',
        detail: 'Started with internal product — HR recruitment platform with RBAC: fullstack architecture, GraphQL API, isolated environments, GitLab CI multi-stage, Docker, SSL auto-renewal, mentoring junior/middle devs. From September 2025 — outstaffed via b-charge to Sber AI initiatives project.',
        stack: 'NestJS · React · Next.js · GraphQL · PostgreSQL · S3 · GitLab CI · Docker' },
      { year: '2025.09', place: 'Sber (via b-charge)', role: 'Senior · AI Systems', domain: 'AI initiatives team',
        detail: 'Outstaffed via b-charge. AI agent development on self-hosted n8n platform. Release cycle automation — Jenkins pipelines orchestrated by Python scripts. Integration with Jira, Bitbucket, DPM. State machine-based orchestration. Reduced manual release operations to near-zero. Automated reporting and decision-making through AI agents.',
