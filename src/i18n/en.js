export default {
  ...
  demos: {
    ...
    items: [
      ...
      { icon: '🩺', title: 'Medical Assistant', desc: 'AI assistant for a neurologist: voice (SaluteSpeech) → structured complaints (GigaChat). GDPR/152-FZ — no medical data stored', url: 'https://med.cheslav.space/', internal: true, tags: ['React', 'FastAPI', 'PWA', 'SaluteSpeech', 'GigaChat', 'Telegram auth'] },
      { icon: '⚽', title: 'WC Score Oracle', desc: 'World Cup 2026 score predictions: odds → Poisson + Dixon-Coles → Telegram lineup alerts 1h before kick-off', url: 'https://wc-oracle.cheslav.space/', internal: true, tags: ['FastAPI', 'APScheduler', 'Poisson', 'SQLAlchemy', 'pytest'] },
    ],
  },
