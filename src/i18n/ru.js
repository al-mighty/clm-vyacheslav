export default {
  ...
  timeline: {
    ...
    items: [
      ...
      { year: '2025.02', place: 'b-charge', role: 'Senior · Fullstack / DevOps', domain: 'HR-tech → Аутстафф в Сбер',
        detail: 'Начал с внутреннего продукта — платформа подбора сотрудников с RBAC: fullstack-архитектура, GraphQL API, изолированные окружения, GitLab CI multi-stage, Docker, SSL-автопродление, менторство junior/middle. С сентября 2025 — аутстафф через b-charge в Сбер на проект AI-инициатив.',
        stack: 'NestJS · React · Next.js · GraphQL · PostgreSQL · S3 · GitLab CI · Docker' },
      { year: '2025.09', place: 'Сбер (через b-charge)', role: 'Senior · AI Systems', domain: 'Команда AI-инициатив',
        detail: 'Аутстафф через b-charge. Разработка AI-агентов на self-hosted n8n. Автоматизация релизного цикла — Jenkins-пайплайны, оркестрированные Python-скриптами. Интеграция с Jira, Bitbucket, DPM. Оркестрация по принципу state machine. Ручные операции при релизах сведены к минимуму. Автоматическая отчётность и принятие решений через AI-агентов.',
