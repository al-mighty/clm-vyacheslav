export default {
  ...
  timeline: {
    ...
    items: [
      ...
      { year: '2018', place: 'PLC.01', role: 'Fullstack · React', domain: 'Финтех',
        detail: 'Инструмент отчётности через Jira REST API. Slack-бот для автоматизации. Мультиязычный финансовый блог (WordPress). PWA финансового портала на React/Redux/WebSocket.',
        stack: 'React · Redux · Storybook · Jest · PHP · WordPress · Jira API' },
      { year: '2020', place: 'FutureComes', role: 'Next + Nest', domain: 'GameDev CRM · PropTech · Крипто',
        detail: 'Три проекта: estoty.com CRM для игровой студии (Next.js + NestJS). themetters.ru агрегатор недвижимости — Python-скраперы парсили объявления с площадок, данные шли в ML-модели для агрегации и отображения. Блог Bequant с Vue.js CMS.',
      ...
      { year: '2022.01', place: 'Ланк Телеком', role: 'Fullstack Developer', domain: 'Телеком · Антифрод',
        detail: 'UI-библиотека (Ant Design → npm через Swagger). Админки антифрода. Strapi CMS для лендингов. LDAP/Active Directory интеграция для SSO и RBAC. Команда из 2 разработчиков.',
      ...
      { year: '2025.02', place: 'b-charge', role: 'Senior · Fullstack / DevOps', domain: 'HR-tech',
        detail: 'Платформа подбора сотрудников с RBAC. Проектирование fullstack-архитектуры. GraphQL API. Изолированные окружения (testing/production). GitLab CI multi-stage, Docker, SSL-автопродление. Менторство junior/middle.',
        stack: 'NestJS · React · Next.js · GraphQL · PostgreSQL · S3 · GitLab CI · Docker' },
      { year: '2025.09', place: 'Сбер', role: 'Senior · AI Systems', domain: 'Команда AI-инициатив',
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'Финтех · торговые порталы (PLC.01)',
